img_scale = (800, 800)
work_dir = './work_dirs/xview/faster_xview_sspnet_lovasz'
# model settings
model = dict(
    type='FasterSSPNet',
    ...
    train_cfg=dict(
        # ------------------------------------------------------------------------
        # whether to use lovasz loss in heatmap, gamma is the loss_weight of lovasz loss
        use_lovasz=True,
        gamma=1,
        # ------------------------------------------------------------------------
        rpn=dict(
...
log_level = 'INFO'
load_from = None
resume_from = 'work_dirs/xview/faster_xview_sspnet_lovasz/epoch_30.pth'
workflow = [('train', 1)]
