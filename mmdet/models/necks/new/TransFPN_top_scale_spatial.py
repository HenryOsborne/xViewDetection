...
class TransFPNTopScaleSpatial(nn.Module):
    def __init__(self,
                 in_channels,
                 out_channels,
                 num_outs,
                 ...
                 depth=2,
                 num_heads=3):
        super(TransFPNTopScaleSpatial, self).__init__()
...
if __name__ == '__main__':
    ...
    neck = TransFPNTopScaleSpatial(in_channels=[96, 192, 384, 768], out_channels=256, num_outs=5)
    y = neck(x)
    print(y)
