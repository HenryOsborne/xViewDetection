...
class TransFPNCANet(nn.Module):
    def __init__(self,
                 ...
                 depth=2,
                 num_heads=3):
        super(TransFPNCANet, self).__init__()
        ...
        for i in range(len(self.in_channels) - 1, 0, -1):
            ...
            self.cbam.append(CoordAtt(out_channels, out_channels))
...
if __name__ == '__main__':
    ...
    neck = TransFPNCANet(in_channels=[96, 192, 384, 768], out_channels=256, num_outs=5)
    y = neck(x)
    print(y)
