...
class HighFPN(nn.Module):
    def __init__(self,
        ...
        self.high_lateral_conv.extend(
            [nn.Conv2d(in_channels[-1], out_channels, (1, 1)) for k in range(len(self.adaptive_pool_output_ratio))])
        self.high_lateral_conv_attention = nn.Sequential(
            nn.Conv2d(out_channels * (len(self.adaptive_pool_output_ratio)), out_channels, (1, 1)), nn.ReLU(),
