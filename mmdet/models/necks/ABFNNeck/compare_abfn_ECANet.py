...
import cv2
import mmcv
from mmdet.models.necks.compare.eca_net import eca_layer
    ...
    def __init__(self, inplanes, reduction_ratio=1, fpn_lvl=4):
        ...
        for i in range(self.fpn_lvl):
            ...
            self.down_conv.append(
                nn.Conv2d(inplanes // reduction_ratio, inplanes // reduction_ratio, kernel_size=(1, 1),
...
class ABFNNeckScaleECANet(nn.Module):
    def __init__(self,
                 in_channels,
                 out_channels,
                 num_outs,
                 ...
                 depth=2,
                 num_heads=3):
        super(ABFNNeckScaleECANet, self).__init__()
        ...
        for i in range(len(self.in_channels) - 1, 0, -1):
            self.cbam.append(eca_layer(mid_channels))
...
if __name__ == '__main__':
    ...
    neck = ABFNNeckScaleECANet(in_channels=[96, 192, 384, 768], out_channels=256, num_outs=5)
    y = neck(x)
    print(y)
