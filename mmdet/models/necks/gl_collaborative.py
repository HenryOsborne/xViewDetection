...
class FPN_GLOBAL(FPN):
    ...
    def forward(self, c2, c3, c4, c5, c2_ext=None, c3_ext=None, c4_ext=None, c5_ext=None,
        ...
        if mode==3:
            ...
            inputs=[c2_fusion,c3_fusion,c4_fusion,c5_fusion]
            out = super(FPN_GLOBAL, self).forward(inputs)
...
class GLNET_FPN_COLLABORATIVE(nn.Module):
    def __init__(self,
                 in_channels,
                 out_channels,
                 num_outs,
                 ):
        super(GLNET_FPN_COLLABORATIVE, self).__init__()
        ...
        self.ensemble_fpn_0 = nn.Conv2d(256 * 2, 256, kernel_size=3, stride=1, padding=1)
        self.ensemble_fpn_1 = nn.Conv2d(256 * 2, 256, kernel_size=3, stride=1, padding=1)
        self.ensemble_fpn_2 = nn.Conv2d(256 * 2, 256, kernel_size=3, stride=1, padding=1)
        self.ensemble_fpn_3 = nn.Conv2d(256 * 2, 256, kernel_size=3, stride=1, padding=1)
    ...
    def collect_local_fm(self, image_global, patches, ratio, top_lefts, oped, batch_size, global_model=None,
        ...
        with torch.no_grad():
            ...
            if len(self.c2_l) == batch_size:
                ...
                #print("s self.ps10_l ",self.ps10_l .size())
                ...
                #print("s self.ps30_l ",self.ps30_l .size())
    ...
    def forward(self, image_global, patches, top_lefts, ratio, templates=None, mode=None, global_model=None,
        ...
        if mode==3:
            ...
            global_fixed = GLNET_FPN_COLLABORATIVE( in_channels=[256, 512, 1024, 2048],out_channels=256, num_outs=5)
            ...
            #print("load state from mode1 to extract basic global feature")
            ...
            #feat=[ feat_fusion[0],feat_fusion[1],feat_fusion[2],feat_fusion[3], F.max_pool2d(feat_fusion[3],1, stride=2) ]
