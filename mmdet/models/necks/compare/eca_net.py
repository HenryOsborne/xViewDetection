...
class ECANeck(nn.Module):
    def __init__(self,
        ...
        self.cbam1 = eca_layer(mid_channels[2])
        self.cbam2 = eca_layer(mid_channels[1])
        if self.use_path_augment:
            self.cbam3 = eca_layer(mid_channels[0])
            self.cbam4 = eca_layer(mid_channels[1])
            self.cbam5 = eca_layer(mid_channels[2])
